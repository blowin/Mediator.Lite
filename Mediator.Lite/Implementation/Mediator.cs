...
namespace Mediator.Lite.Implementation
{
        ...
        where TFactory : IServiceFactory
    {
        ...
        public void Send<TRequest, TResponse>(TRequest request, out TResponse response) 
        ...
        public void SendAsync<TRequest, TResponse>(TRequest request, out ValueTask<TResponse> response, 
